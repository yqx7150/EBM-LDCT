...
if __name__ == "__main__":
    ...
    np.random.seed(0)
    lx = np.random.permutation(1000)[:16] #[993 859 298 553 672 971  27 231 306 706 496 558 784 239 578  55]
    print(lx)
    ims = []
    ...
    for i in range(FLAGS.num_steps):
        ...
        print('x_mod:',np.max(x_mod),np.min(x_mod))
        write_images(abs(x_mod[7]),osp.join('./result/MRI/'+'a_recon'+'.png'))
